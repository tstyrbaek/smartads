...
final class BmcLeasingSiteScraper implements SiteScraperInterface
{
    ...
    public function scrape(string $url): array
    {
        ...
        $energyRating = $extractLabeledValue($xpath, 'Energimærke:');
        ...
        $energyClass = $extractByRegex($pageText, '/Energiklasse:\s*([A-Z][+]*)/u');
        if ($energyRating === null && $energyClass !== null) {
...
final class SiteScraperUtilities
{
